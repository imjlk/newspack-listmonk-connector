...
>({
  ...
  path: '/connector-for-newspack-newsletters-and-listmonk/v1/newsletter-preview/item',
...
export function readNewsletterPreviewResource(
  ...
  return callEndpoint(readNewsletterPreviewResourceEndpoint, request, options);
}
...
>({
  ...
  path: '/connector-for-newspack-newsletters-and-listmonk/v1/newsletter-preview',
