...
function createRenderFixture(): RenderFixture {
	...
	const content = [
		...
		'<!-- wp:quote --><blockquote class="wp-block-quote"><p>Quotes should survive the raw HTML cleanup path.</p><cite>Newspack Listmonk Connector</cite></blockquote><!-- /wp:quote -->',
