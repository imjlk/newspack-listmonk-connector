...
package, creates `artifacts/wp-typia-newsletter-connector-<version>.zip`, and verifies
...
Upload `artifacts/wp-typia-newsletter-connector-<version>.zip` through WP Admin or
